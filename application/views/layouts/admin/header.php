...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/css/atlantis.css">
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="white">
                <a href="<?= base_url() ?>" class="logo">
                    <img src="<?= base_url() ?>assets/assets/img/logo.png" alt="navbar brand" class="navbar-brand" width="125px">
                </a>
