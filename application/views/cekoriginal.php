        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="owl-carousel portfolio-details-carousel">
              <img src="<?php echo base_url() ?>assets/assets/img/home-2.png" class="img-fluid" alt="">
          ...
          <div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="<?php echo base_url()."index.php/cekori/cekproduk"; ?>" method="post" role="form" enctype="multipart/form-data">
              <div class="form-group">
                <br>
              </div>
              <div class="form-group">
                <input type="text" name="kode_unik" class="form-control" id="name" placeholder="Masukkan Kode Produk" data-rule="minlen:4" onkeyup="this.value = this.value.toUpperCase()" data-msg="Wajib diisi" />
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="Perihal" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
            ...
            <br>
            <p align="right"><a href="<?php echo base_url() ?>index.php/info"><img src="<?php echo base_url() ?>assets/assets/img/giveaway.jpg" hight="350px" width="350px"></a></p>
